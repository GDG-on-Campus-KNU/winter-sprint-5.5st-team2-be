...
VALUES (2, 'Nike', 'Air Jordan 1 Retro High OG', 'https://images.example.com/nike/aj1.jpg', 200000, 10, 180000, 50, TRUE, 'The classic AJ1 in High OG silhouette.', 4.8, 'SHOES'); -- CHICKEN은 임시 카테고리 (필요시 Category enum 수정)

INSERT INTO products (store_id, brand, name, image_url, original_price, discount_rate, price, stock, is_available, description, rating, category)
VALUES (2, 'Adidas', 'Yeezy Boost 350 V2', 'https://images.example.com/adidas/yeezy350.jpg', 300000, 0, 300000, 20, TRUE, 'Iconic Yeezy Boost 350 V2 in Beluga colorway.', 4.9, 'SHOES');

INSERT INTO products (store_id, brand, name, image_url, original_price, discount_rate, price, stock, is_available, description, rating, category)
VALUES (2, 'Samsung', 'Galaxy S24 Ultra', 'https://images.example.com/samsung/s24u.jpg', 1600000, 5, 1520000, 100, TRUE, 'Samsung Galaxy S24 Ultra with AI features.', 4.7, 'TOP');

INSERT INTO products (store_id, brand, name, image_url, original_price, discount_rate, price, stock, is_available, description, rating, category)
VALUES (2, 'Apple', 'iPhone 15 Pro', 'https://images.example.com/apple/iphone15pro.jpg', 1500000, 0, 1500000, 80, TRUE, 'iPhone 15 Pro with Titanium build.', 4.9, 'TOP');
